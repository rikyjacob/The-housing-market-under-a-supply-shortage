    ...
    while i <= (pc2 + 0.1):
        ...
        while j <= (pc1 + 0.1):
            ...
            if sumWaitC1F == 0 and sumWaitC1L == 0:
                ...
                waitingTimeC1A.append(sumWaitC1F/(allAgentsC1/1.0))
                waitingTimeC1F.append(sumWaitC1F/(allAgentsC1/1.0))
                waitingTimeC1L.append(0)
            elif sumWaitC1F == 0 and sumWaitC2L > 0:
                waitingTimeC1A.append(sumWaitC1L/(allAgentsC1/1.0))
                waitingTimeC1F.append(0)
                waitingTimeC1L.append(sumWaitC1L/(allAgentsC1/1.0))
            else:
                waitingTimeC1A.append((sumWaitC1F+sumWaitC1L)/((allAgentsC1)/1.0))
                waitingTimeC1F.append(sumWaitC1F/(allAgentsC1/1.0))
                waitingTimeC1L.append(sumWaitC1L/(allAgentsC1/1.0))
            ...
            if sumWaitC2F == 0 and sumWaitC2L == 0:
                ...
                waitingTimeC2A.append(sumWaitC2F/(allAgentsC2/1.0))
                waitingTimeC2F.append(sumWaitC2F/(allAgentsC2/1.0))
                waitingTimeC2L.append(0)
            elif sumWaitC2F == 0 and sumWaitC2L > 0:
                waitingTimeC2A.append(sumWaitC2L/(allAgentsC2/1.0))
                waitingTimeC2F.append(0)
                waitingTimeC2L.append(sumWaitC2L/(allAgentsC2/1.0))
            else:
                waitingTimeC2A.append((sumWaitC2F+sumWaitC2L)/((allAgentsC2)/1.0))
                waitingTimeC2F.append(sumWaitC2F/(allAgentsC2/1.0))
                waitingTimeC2L.append(sumWaitC2L/(allAgentsC2/1.0))
            ...
            if sumWaitTF == 0 and sumWaitTL == 0:
                ...
                waitingTimeTA.append(sumWaitTF/(allAgentsT/1.0))
                waitingTimeTF.append(sumWaitTF/(allAgentsT/1.0))
                waitingTimeTL.append(0)
            elif sumWaitTF == 0 and sumWaitTL > 0:
                waitingTimeTA.append(sumWaitTL/(allAgentsT/1.0))
                waitingTimeTF.append(0)
                waitingTimeTL.append(sumWaitTL/(allAgentsT/1.0))
            else:
                waitingTimeTA.append((sumWaitTF+sumWaitTL)/((allAgentsT)/1.0))
                waitingTimeTF.append(sumWaitTF/(allAgentsT/1.0))
                waitingTimeTL.append(sumWaitTL/(allAgentsT/1.0))
