...
while i <= (pc2 + 0.1):
    ...
    dc1TookArrivedT.append(round(dFoundC1/(arrivedTotal/1.0),3))
    dc2TookArrivedT.append(round(dFoundC2/(arrivedTotal/1.0),3))
    dLeftArrivedT.append(round(dLeftTheMarket/(arrivedTotal/1.0),3))
    dSearching.append(round((arrivedTotal-dFoundC1-dFoundC2-dLeftTheMarket)/(arrivedTotal/1.0),3))
    ...
    if sumWaitC1F == 0 and sumWaitC1L == 0:
        ...
        waitingTimeC1A.append(round(sumWaitC1F/(agntsFoundC1/1.0),3))
        waitingTimeC1F.append(round(sumWaitC1F/(agntsFoundC1/1.0),3))
        waitingTimeC1L.append(0)
    elif sumWaitC1F == 0 and sumWaitC2L > 0:
        waitingTimeC1A.append(round(sumWaitC1L/(agntsLeftC1/1.0),3))
        waitingTimeC1F.append(0)
        waitingTimeC1L.append(round(sumWaitC1L/(agntsLeftC1/1.0),3))
    else:
        waitingTimeC1A.append(round((sumWaitC1F+sumWaitC1L)/((agntsFoundC1+agntsLeftC1)/1.0),3))
        waitingTimeC1F.append(round(sumWaitC1F/(agntsFoundC1/1.0),3))
        waitingTimeC1L.append(round(sumWaitC1L/(agntsLeftC1/1.0),3))
    ...
    if sumWaitC2F == 0 and sumWaitC2L == 0:
        ...
        waitingTimeC2A.append(round(sumWaitC2F/(agntsFoundC2/1.0),3))
        waitingTimeC2F.append(round(sumWaitC2F/(agntsFoundC2/1.0),3))
        waitingTimeC2L.append(0)
    elif sumWaitC2F == 0 and sumWaitC2L > 0:
        waitingTimeC2A.append(round(sumWaitC2L/(agntsLeftC2/1.0),3))
        waitingTimeC2F.append(0)
        waitingTimeC2L.append(round(sumWaitC2L/(agntsLeftC2/1.0),3))
    else:
        waitingTimeC2A.append(round((sumWaitC2F+sumWaitC2L)/((agntsFoundC2+agntsLeftC2)/1.0),3))
        waitingTimeC2F.append(round(sumWaitC2F/(agntsFoundC2/1.0),3))
        waitingTimeC2L.append(round(sumWaitC2L/(agntsLeftC2/1.0),3))
    ...
    if sumWaitTF == 0 and sumWaitTL == 0:
        ...
        waitingTimeTA.append(round(sumWaitTF/(agntsFoundT/1.0),3))
        waitingTimeTF.append(round(sumWaitTF/(agntsFoundT/1.0),3))
        waitingTimeTL.append(0)
    elif sumWaitTF == 0 and sumWaitTL > 0:
        waitingTimeTA.append(round(sumWaitTL/(agntsLeftT/1.0),3))
        waitingTimeTF.append(0)
        waitingTimeTL.append(round(sumWaitTL/(agntsLeftT/1.0),3))
    else:
        waitingTimeTA.append(round((sumWaitTF+sumWaitTL)/((agntsLeftT+agntsFoundT)/1.0),3))
        waitingTimeTF.append(round(sumWaitTF/(agntsFoundT/1.0),3))
        waitingTimeTL.append(round(sumWaitTL/(agntsLeftT/1.0),3))
...
val1 = ["{:d}".format(i) for i in range(pc2+1)] 
...
ax.set_title("Data after 2000 iterations over P \n " + " λT = " + str(lamT_c12) +  "λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2), fontweight ="bold") 
