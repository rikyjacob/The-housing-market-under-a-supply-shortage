...
plt.title("Average waiting times after 2000 iterations over λTenants in C1 \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λT")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λTenants in C2 \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λT")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λTenants in Tenants \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λT")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λTenants in All \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λT")
plt.ylabel("Rate")
plt.plot(lT, waitingTimeC1A, label='All C1')
plt.plot(lT, waitingTimeC2A, label='All C2')
