...
plt.figure("Average waiting times after 2000 iterations in C1")
...
plt.figure("Average waiting times after 2000 iterations in C2")
...
plt.figure("Average waiting times after 2000 iterations in Tenants")
...
plt.title("Average waiting times after 2000 iterations over λC2 in All \n λTenants = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " P = " + str(pc2))
plt.xlabel("λC2")
plt.ylabel("Rate")
plt.plot(lT, waitingTimeC1A, label='All C1')
plt.plot(lT, waitingTimeC2A, label='All C2')
