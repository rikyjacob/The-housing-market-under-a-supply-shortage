...
plt.title("Average waiting times after 2000 iterations over λT in C1 \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λT")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λT in C2 \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λT")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λT in Tenants \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λT")
plt.ylabel("Rate")
...
########################
#######################
plt.figure("Average waiting times after 2000 iterations")
plt.title("Average waiting times after 2000 iterations over λA \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%" + " pMC2 = " + str(pc2) + "%")
plt.xlabel("λA")
...
plt.figure("Rates of total agents distribution over λT after 2000 iterations")
plt.title("Market with dynamic λA and \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%" + " pMC2 = " + str(pc2) + "%")
plt.xlabel("λA")
plt.ylabel("Ratio")
...
val1 = ["{:d}".format(i) for i in range(lamT_c12+1)] 
...
table = ax.table( 
    ...
    rowLabels = val2,  
    colLabels = val1, 
    rowColours =["skyblue"] * 21,  
    colColours =["skyblue"] * 21, 
    cellLoc ='center',  
    loc ='upper left')         
   
table.auto_set_font_size(False)
table.set_fontsize(10)
ax.set_title("Data after 2000 iterations over λA \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%" + " pMC2 = " + str(pc2) + "%", fontweight ="bold")
