...
plt.title("Average waiting times after 2000 iterations over λC1 in C1 \n λTenants = " + str(lamT_c12) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λC1")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λC1 in C2 \n λTenants = " + str(lamT_c12) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λC1")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λC1 in Tenants \n λTenants = " + str(lamT_c12) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λC1")
plt.ylabel("Rate")
...
plt.figure("Average waiting times after 2000 iterations for λC1")
plt.title("Average waiting times after 2000 iterations over λC1 with:  \n λA = " + str(lamT_c12) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%" + " pMC2 = " + str(pc2) + "%")
plt.xlabel("λC1")
...
plt.figure("Rates of total agents on elections over λC1 after 2000 iterations")
plt.title("Market with dynamic λC1 and \n λA = " + str(lamT_c12) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%" + " pMC2 = " + str(pc2) + "%")
plt.xlabel("λC1")
plt.ylabel("Ratio")
...
ax.set_title("Data after 2000 iterations over λC1 \n λA = " + str(lamT_c12) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%" + " pMC2 = " + str(pc2) + "%", fontweight ="bold") 
