...
plt.title("Average waiting times after 2000 iterations over pMC2 \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%")
plt.xlabel("pMC2")
plt.ylabel("Ratio")
...
plt.figure("Rates of total agents on elections over PC2 after 2000 iterations")
plt.title("Market with dynamic pMC2 and \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%")
plt.xlabel("pMC2")
plt.ylabel("Ratio")
...
table = ax.table( 
    ...
    rowLabels = val2,  
    colLabels = val1, 
    rowColours =["skyblue"] * 100,  
    colColours =["skyblue"] * 100, 
    cellLoc ='center',  
    loc ='upper left')         
   
table.auto_set_font_size(False)
table.set_fontsize(6)
ax.set_title("Data after 2000 iterations over pMC2 \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pTC1 = " + str(pc1) + "%", fontweight ="bold") 
