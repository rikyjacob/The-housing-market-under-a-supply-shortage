...
plt.title("Average waiting times after 2000 iterations over λC2 in C1 \n λTenants = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " P = " + str(pc2))
plt.xlabel("λC2")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λC2 in C2 \n λTenants = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " P = " + str(pc2))
plt.xlabel("λC2")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λC2 in Tenants \n λTenants = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " P = " + str(pc2))
plt.xlabel("λC2")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over λC2 \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " pTC1 = " + str(pc1) + " pMC2 = " + str(pc2) + "%")
plt.xlabel("λC2")
plt.ylabel("Ratio")
...
plt.title("Market with dynamic λC2 and \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " pTC1 = " + str(pc1) + " pMC2 = " + str(pc2) + "%")
plt.xlabel("λC2")
plt.ylabel("Ratio")
...
val1 = ["{:d}".format(i) for i in range(lamL_c2+1)] 
...
ax.set_title("Data after 2000 iterations over λC2 \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " pTC1 = " + str(pc1) + " pMC2 = " + str(pc2) + "%", fontweight ="bold") 
