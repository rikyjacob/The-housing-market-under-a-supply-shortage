...
plt.title("Average waiting times after 2000 iterations over PC1 in C1 \n λTenants = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " PC2 = " + str(pc2))
plt.xlabel("PC1")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over PC1 in C2 \n λTenants = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " PC2 = " + str(pc2))
plt.xlabel("PC1")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over PC1 in Tenants \n λTenants = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " PC2 = " + str(pc2))
plt.xlabel("PC1")
plt.ylabel("Rate")
...
plt.title("Average waiting times after 2000 iterations over pTC1 with: \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pMC2 = " + str(pc2) + "%")
plt.xlabel("pTC1")
plt.ylabel("Ratio")
...
plt.figure("Rates of total agents on elections over PC1 after 2000 iterations")
plt.title("Market with dynamic pTC1 and \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pMC2 = " + str(pc2) + "%")
plt.xlabel("pTC1")
plt.ylabel("Ratio")
...
ax.set_title("Data after 2000 iterations over pTC1 \n λA = " + str(lamT_c12) + " λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " pMC2 = " + str(pc2) + "%" , fontweight ="bold") 
