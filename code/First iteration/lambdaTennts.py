    ...
    while t <= expLength:
        ...
        for x in arrivalTimesTenants:
            if x == t:
                ...
                arrived += 1
                arrivedTotal += 1
#TODO checar tambien que la casa este libre
                ...
                if len (FCFS_C1) == 1 and len(residences_c1): #TODO Bug
...
plt.figure("Rates of total agents on elections over λTennants after 2000 iterations")
plt.title("Rates of total agents on elections over λTennants after 2000 iterations \n λC1 = " + str(lamL_c1) + " λC2 = " + str(lamL_c2) + " P = " + str(pc2))
plt.xlabel("λTennants")
plt.ylabel("Rate")
